...
class PratsRoomtypes_Shortcodes_Emailform extends PratsRoomtypes_Helpers_Shortcode
{
    /**
    ...
    */
    ...
    {
        // Add shortcode
        add_shortcode('roomtypes_emailform', array (__CLASS__, 'render'));
    }
    ...
    public static function render()
    {
		...
		echo '<iframe allowTransparency="true" style="min-height:650px; height:inherit; overflow:auto;" width="100%" id="contactform123" name="contactform123" marginwidth="0" marginheight="0" frameborder="0" src="http://www.123contactform.com/sf.php?s=123contactform-2459053&control25726315='.$company_id.'&control25745919='.$property_link.'&control25726316='.$property_title.'">
